...
WASI could be an alternative which is not as good as direct IPFS integration though since it requires additional runtime outside of the browser and adds an additional layer to deal with.
